; Develop an ALP using 8086 microprocessor for multiplication of 16/32 bit numbers.
data segment
mnd db 04h
mr db 03h
product db ?
...
mov product, al ; copies result of 8 bit multiplication from register ax into variable
